 ...
 */
public class FFmpegTransitionEncoder2 extends AsyncTask<Integer, Integer, Integer> implements ICommandProvider {
    static int vidcount;
    ...
    public FFmpegTransitionEncoder2(android.content.Context ctx) {
        this.ctx = ctx;
    }
